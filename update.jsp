...
%>
				...
				<form action="ControllerServlet">
						<h3 class="text-center text-info">Update Post Here</h3>
                            <div class="form-group">
                                <label for="id" class="text-info">Id:</label><br>
                                <input type="text"  name="id"  placeholder="enter post id" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input  class="btn" type="submit" name="buttonName" value="update">
	</div>
	<br /><br />

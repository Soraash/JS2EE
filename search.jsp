...
%>
							...
							<h3 class="text-center text-info">Search post here</h3>
								<div class="form-group">
                                <label for="id" class="text-info">Id:</label><br>
                                <input type="text"  name="id" id="title"  placeholder="enter id" class="form-control">
                            	</div>
								  <div class="form-group">
                                <input   class="btn" type="submit" name="buttonName" value="search">
		<br /><br />
		</div>
